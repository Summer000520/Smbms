            ...
            <ul class="layui-nav layui-nav-tree layui-left-nav-tree layui-this" id="currency">
                <li class="layui-nav-item">
                    <a href="javascript:;" class="layui-menu-tips"><i class="fa fa-street-view"></i><span
                                class="layui-left-nav"> 用户管理</span> <span class="layui-nav-more"></span></a>
                    <dl class="layui-nav-child">
                        <dd>
                ...
                <li class="layui-nav-item">
                    <a href="javascript:;" class="layui-menu-tips"><i class="fa fa-jpy"></i><span
                                class="layui-left-nav"> 订单管理</span> <span class="layui-nav-more"></span></a>
                    <dl class="layui-nav-child">
                        <dd>
                            <#-- data-tab 是请求controller中的路径 -->
                            <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd" data-tab-mpi="m-p-i-1"
                               data-tab="order/index" target="_self"><i class="fa fa-calculator"></i><span
                                        class="layui-left-nav"> 订单管理</span></a>
                        </dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
                    <a href="javascript:;" class="layui-menu-tips"><i class="fa fa-handshake-o"></i><span
                                class="layui-left-nav"> 供货商管理</span> <span class="layui-nav-more"></span></a>
                    <dl class="layui-nav-child">
                        <dd>
                            <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd" data-tab-mpi="m-p-i-3"
                               data-tab="provider/index" target="_self"><i class="fa fa-exchange"></i><span
                                        class="layui-left-nav"> 供货商管理</span></a>
                        </dd>
                    </dl>
                </li>
